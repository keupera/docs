...
```json
{
  "website_id": "uuid",
  "name": "Q4 monitoring",
  "prompts": ["best running shoes 2026", "top trail running gear"],
  "frequency": "weekly"
}
```
...
| `prompts` | Yes | Array of prompts/queries to track |
| `frequency` | No | Run frequency: `daily`, `weekly`, `monthly` (default `weekly`) |
...
```json
{
  "website_id": "uuid",
  "name": "Top-of-funnel",
  "prompts": ["how to choose running shoes", "best running shoes for beginners"]
}
```
...
|-------|----------|-----------|
| `name` | Yes | Campaign name |
| `prompts` | Yes | Array of prompts to research and cluster |
